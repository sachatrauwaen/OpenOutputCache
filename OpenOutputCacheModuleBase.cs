...
namespace Satrabel.OpenOutputCache
{
    ...
    /// are accessible to your module's controls (that inherity from OpenOutputCacheModuleBase
    /// 
    /// </summary>

    public class OpenOutputCacheModuleBase : DotNetNuke.Entities.Modules.PortalModuleBase
    {
    }
}
